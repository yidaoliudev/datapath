...
func (msg *TcSfqOpt) Len() int {
	return SizeofTcSfq
}

func DeserializeTcSfq(b []byte) *TcSfqOpt {
	return (*TcSfqOpt)(unsafe.Pointer(&b[0:SizeofTcSfq][0]))
}

func (x *TcSfqOpt) Serialize() []byte {
	return (*(*[SizeofTcSfq]byte)(unsafe.Pointer(x)))[:]
}
